...
final class Misc {
    ...
    public function getShippingMethods($language_id, $geo_zones = array(), $inc_xshipping = true, $base_only = false) {
        ...
        if (defined('DIR_STORAGE') && file_exists(DIR_STORAGE . 'shipping.json')) {
            $json = @file_get_contents(DIR_STORAGE . 'shipping.json');
            ...
            if (is_array($json_methods)) {
                ...
                $this->log->write("Invalid JSON file" . DIR_STORAGE . 'shipping.json');
            }
        }
